...
\begin{document}
	...
	\include{Initial_Pages/blankpage}
	
	\include{Initial_Pages/titlepage}
	\include{Initial_Pages/blankpage}
	
	\include{Initial_Pages/title_back}
	\include{Initial_Pages/blankpage}
	
%	\AddToShipoutPicture{\BackgroundPic}  %watermark start
% 	\include{Initial_Pages/certificate}
    \newpage
    \includepdf[pages={1}]{Initial_Pages/certificate.pdf}
	%\ClearShipoutPicture % watermark end
	%\include{Initial_Pages/certificate_back}
	
%	\include{Initial_Pages/copyright}
	\include{Initial_Pages/blankpage}
	
	%\include{Initial_Pages/shloka}
	%\include{Initial_Pages/blankpage}
