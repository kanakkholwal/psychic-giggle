...
The Autoencoder has the hyperparametjhgher initialization as shown in Table \ref{table: auto}, which has been chosen for optimal performance.
...
\begin{figure}[htb]
\centering\includegraphics[width=0.7\linewidth]{figimages/PSNRplot.png}
\caption{PSNR Training Plot} 
\label{fig: PSNR}
\end{figure}

\begin{figure}[htb]
\centering\includegraphics[width=0.7\linewidth]{figimages/MSEplot.png}
...
\begin{figure}[htb]
\centering\includegraphics[width=\linewidth]{figimages/Comparison.png}
...
\begin{figure}[htb]
\centering\includegraphics[width=0.75\linewidth]{figimages/acc5Layered.png}
\caption{Training Accuracy plot for Five-layered CNN} 
\label{fig:trainingAcc5CNN}
\end{figure}
\begin{figure}[htb]
\centering\includegraphics[width=0.75\linewidth]{figimages/loss5Layered.png}
...
\begin{figure}[H]
\centering\includegraphics[width=0.75\linewidth]{figimages/confusion5Layered.png}
...
\begin{figure}[H]
\centering\includegraphics[width=0.75\linewidth]{figimages/accBottleneck.png}
\caption{Training Accuracy plot for Bottleneck CNN} 
\label{fig:trainingAccbottle}
\end{figure}

\begin{figure}[H]
\centering\includegraphics[width=0.75\linewidth]{figimages/lossBottleneck.png}
...
\begin{figure}[H]
\centering\includegraphics[width=0.75\linewidth]{figimages/confusionBottleneck.png}
